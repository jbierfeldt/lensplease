...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PhotographerRequest.date_needed'
        db.alter_column(u'requests_photographerrequest', 'date_needed', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'PhotographerRequest.date_needed'
        db.alter_column(u'requests_photographerrequest', 'date_needed', self.gf('django.db.models.fields.DateField')(default='slkjdf'))
