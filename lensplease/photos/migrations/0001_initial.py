...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PortfolioPhoto'
        db.create_table(u'photos_portfoliophoto', (
            ...
            ('photographer_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photographer.PhotographerProfile'])),
        ))
        db.send_create_signal(u'photos', ['PortfolioPhoto'])


    def backwards(self, orm):
        # Deleting model 'PortfolioPhoto'
        db.delete_table(u'photos_portfoliophoto')
    ...
    models = {
        ...
        u'photos.portfoliophoto': {
            'Meta': {'object_name': 'PortfolioPhoto'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('cloudinary.models.CloudinaryField', [], {'max_length': '100'}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'photographer_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['photographer.PhotographerProfile']"}),
